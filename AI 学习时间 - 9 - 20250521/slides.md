...
关键词：#大语言模型 #指令微调 #人类对齐 #大语言模型训练流程

2025-05-21 (第9课) @矩阵前端研发二组
...
> 输入：Large language models have become one important research direction for machine learning <br />
...
> 输入：请将这个句子翻译为中文“Large language models have become one important research direction for machine learning” <br />
> 输出：大语言模型已经成为机器学习的一个重要研究方向
...
- 整体任务性能改进
  ...
  - 经过指令微调的小模型可以比没有经过微调的大模型表现得更出色，进一步凸显指令微调的有效性。
...
<img src="/rlhf.png" class="h-70" style="margin: auto" />
